...
#define PACKET_RLY_CMD 10002  //RLY requset CMD 表示cmd类型回复数据		服务端--->客户端
//键盘类型数据
#define PACKET_REQ_KEYBOARD 20001  //REQ requset 键盘 表示键盘类型请求数据		客户端--->服务端
#define PACKET_RLY_KEYBOARD 20002  //RLY requset 键盘 表示键盘类型回复数据		服务端--->客户端
